...
export const groups = pgTable(
  'groups',
  {
    ...
    parentGroupId: uuid('parentGroupId'), // Self-reference - simplified
...
// Zod schemas for validation - simplified without customization
export const insertUserSchema = createInsertSchema(users);
export const selectUserSchema = createSelectSchema(users);

// User types derived from schemas
export type InsertUser = typeof insertUserSchema._input;
export type SelectUser = typeof selectUserSchema._output;
